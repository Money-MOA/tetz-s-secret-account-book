<template>
  <div class="flex flex-col m-[0rem] pt-[3rem] h-screen px-[5rem] bg-[#f3f3f3]">
    <div
    ...
    >
      ...
      >
        <i class="fa-solid fa-user text-[3rem] text-gray-700"></i>
      </div>
      <div class="w-[25rem] flex flex-col self-center gap-[0.3rem]">
        이름 <br />
        <input
          type="text"
